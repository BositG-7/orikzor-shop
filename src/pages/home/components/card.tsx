...
export const Card: FunctionComponent<CardProps> = ({ price, title, description, image, cartImage, percentage }) => {
	const i = 0;
		...
		<>
			<Box sx={{border:"1px solid grey",borderRadius:"10px",'&:hover': {
				...
				<Flex
                    ...
                    <Box w={150}><Text>осталось 7шт</Text><Progress radius="md" h={7} value={40}/></Box>
                    ...
                    <Flex><img src={star} width="20px" height="20px" alt='title'/><Text sx={{color: "rgba(0, 26, 52, 0.6)",fontSize:"15px"}}>4.7</Text></Flex>
					<Button w="100%" h={50} mt={10} sx={{backgroundColor:"#005bff"}}>
						<img src={cartImage} width="20px" height="20px" alt="" />
						<Text pl={10} sx={{fontSize: "16px",fontWeight: 500,letterSpacing: ".2px",lineHeight: "20px"}}>Add to Cart</Text>
					</Button>
				</Flex>
			</Box>
		</>
